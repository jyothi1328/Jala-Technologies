...
def scientificCalculator(): 
             print("Calculator opened in other window")
             class Calc():
                 def __init__(self):
                     self.total=0
                     self.current=""
             ...
             lblDisplay=Label(calc, text="Jala Technologies", font=('arial', 30, 'bold'), justify =CENTER)
...
def normalCalculator():
             ...
             while True:
                          ...
                          if choice in ('1', '2', '3', '4'):
                                  ...
                                  print("Invalid Input, Please select either 1 or 2 or 3 or 4 only")

choice=input("Enter Choice 1.scientificCalculator 2.normalCalculator")
